...
const aswinRaj = {
  ...
  goal:
    "Land my first developer role and build impactful products",
...
- 🔨 Building React projects consistently
- 📚 Learning backend development with Node.js
- 🌱 Expanding knowledge of Express.js and MongoDB
- 🚀 Preparing for full MERN stack applications
